...
skill.mets.all <- readRDS(file.path(base.dir,PE.cfg$dirs$results,PE.cfg$files$scalar.skill.metrics))
stat.dat <- readRDS(file.path(base.dir,PE.cfg$dirs$results,PE.cfg$files$scalar.stats))
