...
#'========================================================================
#Import data
db.stats <- PE.db.connection(pcfg,PE.cfg$db$stats)
stats.tbl <- tbl(db.stats,PE.cfg$db$stats)
db.mets <- PE.db.connection(pcfg,PE.cfg$db$metrics)
mets.tbl <- tbl(db.mets,PE.cfg$db$metrics)
...
dbDisconnect(db.stats)
dbDisconnect(db.mets)
```
