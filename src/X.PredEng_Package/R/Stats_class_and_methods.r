...
#' @param do.field.metrics Should field metrics be calculated for this particular stat. Defaults to FALSE. These
#' can be computationally expensive, so need to be opted into.
#' @name stat
#' @export stat
#' @exportClass stat
stat <- 
  setClass("stat",
           slots=list(name="character",
                      ...
                      do.field.metrics="logical"),
           prototype = list(apply.to.realisations=TRUE,
                            retain.field=FALSE,
                            use.globalROI=FALSE,
                            do.field.metrics=FALSE),
