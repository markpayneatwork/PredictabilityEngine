...
#' "Mean adjusted".
#' @param use.spatial.polygons Indicates whether the stat should be calculated on a local or 
#' global basis  ie. for each individual spatial polygon (TRUE) or once for the entire global 
#' ROI (FALSE) 
