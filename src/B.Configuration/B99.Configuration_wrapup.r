...
cfgs <- partition.workload(pcfg,"NMME","By Sources")
cfgs <- partition.workload(pcfg,"NMME","Ensmean")
cfgs <- partition.workload(pcfg,"Decadal","By Sources")
cfgs <- partition.workload(pcfg,"Decadal","By Chunks")
cfgs <- partition.workload(pcfg,"Decadal","Ensmean")
cfgs <- partition.workload(pcfg,"Observations","By Sources")
