#/*##########################################################################*/
#' Eel Predictability Configuration - Spring
#' ==========================================================================
#'
#' by Mark R Payne  
...
#Use the standard Eel configruation as the template
source("src/B.Configuration/B4.Eel-Configuration.r")

#Rename it
pcfg@name <- "Eel-Spring"

#Adjust the MOI
pcfg@MOI <- 2:6

#Add a set of EN4 observations at depth as well
# pcfg@observations <- c(pcfg@observations,
#                        list(data_src(name="EN4-deep",type="obs",
#                                    source="EN4",
#                                    var="temperature",
#                                    levels=7:14)))
