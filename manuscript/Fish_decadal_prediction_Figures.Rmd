...
#  filter(metric %in% c("MSSS","pearson.correlation")) %>%
  ...
  mutate(smoothing=case_when(is.na(smoothing) ~ "1 year",
                             smoothing=="RollMean3" ~ "3 years",
                             smoothing=="RollMean5" ~ "5 years",
                             smoothing=="RollMean9" ~ "9 years"),
...
# Setup configuration -------------------------------------------------------------
forecast.cfg.l <- list()
forecast.cfg.l$Mackerel_summer <-
...
# forecast.cfg.l$Blue_whiting_decadal <-
...
this.cfg <- 
  these.cfg %>%
  filter(name=="Blue_whiting_decadal")%>%
