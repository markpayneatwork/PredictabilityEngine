...
forecast.cfg.l$Mackerel_summer <- 
  tibble(yr.rng=list(1980:2020),
         starts=list(c(1990,2000,2011)),
         scalar=1/1e6,
         lbl2="Area of Mackerel habitat (Mkm²)")

forecast.cfg.l$Bluefin <- 
  tibble(yr.rng=list(1980:2020),
         starts=list(c(1982,1992,2002,2011)),
         scalar=-1,
...
sp.plt.cfg$cor <- 
  list(metric="pearson.correlation",
    fill.breaks= c(0.25,seq(0.4,0.8,by=0.2)),
       ...
       fill.pal = ggplot2:::binned_pal(scales::manual_pal(c("white",brewer.pal(4,"Reds")))),
       fill.ttl = "Pearson\ncorrelation (r)",
       fill.even = FALSE)
